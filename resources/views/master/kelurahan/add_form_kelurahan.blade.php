    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="addModalLabel">Add New Kelurahan</h1>
            ...
            <form id="add_form" class="form" action="#" autocomplete="off" method="POST">
                ...
                <div class="modal-body">
                    <div class="fv-row mb-10">
                        <label for="kabtxt" class="required form-label">Kecamatan</label>
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <input type="text" id="kdtxt" name="kdtxt" class="form-control form-control-solid" required="" maxlength="10" onkeypress="return isNumber(event)"/>
                    </div>
                    <div class="fv-row mb-10">
        ...
        fields: {
            ...
            kdtxt: {
                validators: {
                    ...
                    stringLength: {
                        max: 10,
                        message: 'The kode must be 10 characters long'
                    }
                }
            },
            nmatxt: {
