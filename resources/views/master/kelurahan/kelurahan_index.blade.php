...
<div class="card">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="table-kec" class="table table-rounded table-hover border my-5">
                <thead>
...
@include('master.kelurahan.add_form_kelurahan')
@endif
@if($user_access['update'])
@include('master.kelurahan.edit_form_kelurahan')
@endif
@if($user_access['delete'])
@include('master.kelurahan.delete_form_kelurahan')
@include('master.kelurahan.restore_form_kelurahan')
@endif
@endsection
@push('scripts')
...
@include('master.kelurahan.table_kelurahan')
@endpush