...
@include('master.kecamatan.add_form_kecamatan')
@endif
@if($user_access['update'])
@include('master.kecamatan.edit_form_kecamatan')
@endif
@if($user_access['delete'])
@include('master.kecamatan.delete_form_kecamatan')
@include('master.kecamatan.restore_form_kecamatan')
@endif
@endsection
@push('scripts')
...
@include('master.kecamatan.table_kecamatan')
@endpush