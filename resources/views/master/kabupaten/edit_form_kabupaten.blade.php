        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.success) {
                    ...
                    $('#lattxt2').val(data.dt_kabupaten['coordinates']['coordinates'][1]);
                    $('#longtxt2').val(data.dt_kabupaten['coordinates']['coordinates'][0]);
                ...
                fields: {
                    ...
                    kdtxt2: {
                        validators: {
                            ...
                            stringLength: {
                                max: 4,
                                message: 'The kode must be less than 4 characters long'
                            }
                        }
                    },
                    nmatxt2: {
