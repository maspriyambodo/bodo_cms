    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="deleteModalLabel">Delete Kabupaten</h1>
    ...
    function deleteData(id_menu) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.success) {
                    $('input[name="d_id"]').val(data.dt_kabupaten.id_kabupaten);
                    $('#deltxt').html('Are you sure you want to delete kabupaten <strong>' + data.dt_kabupaten['nama'] + '</strong>?');
        ...
        if (validator3) {
            validator3.validate().then(function (status) {
                if (status == 'Valid') {
                    ...
                    fetch('kabupaten/store/?q=delete', {
                        method: 'POST',
                        body: formData
                    })
