...
<div class="card">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="table-kab" class="table table-rounded table-hover border my-5">
                <thead>
...
@include('master.kabupaten.add_form_kabupaten')
@endif
@if($user_access['update'])
@include('master.kabupaten.edit_form_kabupaten')
@endif
@if($user_access['delete'])
@include('master.kabupaten.delete_form_kabupaten')
@include('master.kabupaten.restore_form_kabupaten')
@endif
@endsection
@push('scripts')
...
@include('master.kabupaten.table_kabupaten')
@endpush