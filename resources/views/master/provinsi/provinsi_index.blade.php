...
<div class="card">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="table-prov" class="table table-rounded table-hover border my-5">
                <thead>
...
@include('master.provinsi.add_form_provinsi')
@endif
@if($user_access['update'])
@include('master.provinsi.edit_form_provinsi')
@endif
@if($user_access['delete'])
@include('master.provinsi.delete_form_provinsi')
@include('master.provinsi.restore_form_provinsi')
@endif
@endsection
@push('scripts')
...
@include('master.provinsi.table_provinsi')
@endpush