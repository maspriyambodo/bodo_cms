            ...
            <form id="add_form" class="form" action="#" autocomplete="off" method="POST">
                ...
                <div class="modal-body">
                    <div class="fv-row mb-10">
                        ...
                        <select id="parenttxt" name="parenttxt" class="form-control form-control-solid form-select parenttxt">
                            <option value="0">Parent</option>
                        </select>
                    </div>
                    <div class="fv-row mb-10">
                        <label for="nametxt" class="required form-label">Name</label>
                        <input type="text" id="nametxt" name="nametxt" class="form-control form-control-solid" required=""/>
                    </div>
                    <div class="fv-row mb-10">
                        <label for="descrptiontxt" class="form-label">Description</label>
                        <textarea id="descrptiontxt" name="descrptiontxt" class="form-control form-control-solid" required=""></textarea>
                    </div>
                </div>
            ...
            validator.validate().then(function (status) {
                if (status == 'Valid') {
                    ...
                    fetch('user-groups/store/?q=add', {
                        ...
                        Swal.fire({
                            text: "error while insert data, errcode: 28022335",
                            icon: "error",
                            buttonsStyling: !1,
                            confirmButtonText: "OK",
                            allowOutsideClick: false,
