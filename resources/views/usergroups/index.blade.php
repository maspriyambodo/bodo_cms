                        ...
                        <div class="d-flex justify-content-end mb-10">
                            <div class="d-flex flex-column align-items-end">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt=Pic src="{{ asset('src/media/avatars/150-26.jpg'); }}">
                                    </div>
                                </div>
                    ...
                    <div class="modal-body py-lg-10 px-lg-10">
                        <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id=kt_modal_create_app_stepper>
                            ...
                            <div class="flex-row-fluid py-lg-5 px-lg-15">
                                <form class=form novalidate id=kt_modal_create_app_form>
                                    <div class=current data-kt-stepper-element=content>
                                        <div class=w-100>
                                            <div class="fv-row mb-10">
                                                ...
                                                <input class="form-control form-control-lg form-control-solid" name=name placeholder="">
                                            </div>
                                            <div class=fv-row>
                                    ...
                                    <div data-kt-stepper-element=content>
                                        <div class=w-100>
                                            <div class="fv-row mb-10">
                                                ...
                                                <input class="form-control form-control-lg form-control-solid" name=dbname placeholder="" value=master_db>
                                            </div>
                                            <div class=fv-row>
                                                <label class="d-flex align-items-center fs-5 fw-bold mb-4">
                                    ...
                                    <div data-kt-stepper-element=content>
                                        <div class=w-100>
                                            <div class="d-flex flex-column mb-7 fv-row">
                                                ...
                                                <input class="form-control form-control-solid" placeholder="" name=card_name value="Max Doe">
                                            </div>
                                            <div class="d-flex flex-column mb-7 fv-row">
                                                <label class="required fs-6 fw-bold form-label mb-2">Card Number</label>
                                                <div class=position-relative>
                                                    <input class="form-control form-control-solid" placeholder="Enter card number" name=card_number value="4111 1111 1111 1111">
                                            ...
                                            <div class="row mb-10">
                                                ...
                                                <div class="col-md-4 fv-row">
                                                    ...
                                                    <div class=position-relative>
                                                        <input class="form-control form-control-solid" minlength=3 maxlength=4 placeholder=CVV name=card_cvv>
                                        ...
                                        <div class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 active mb-6" data-bs-toggle=tab data-bs-target=#kt_upgrade_plan_startup>
                                            <div class="d-flex align-items-center me-2">
                                                <div class="form-check form-check-custom form-check-solid form-check-success me-6">
                                                    <input class=form-check-input type=radio name=plan checked value=startup>
                                                </div>
