                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning d-flex align-items-center p-5 mb-10">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <span>restoring data permissions causes the user to be able to access the system again</span>
                        </div>
                    </div>
                    <div class="fv-row mb-10">
                        <label for="parenttxt3" class="required form-label">Parent</label>
                        <select id="parenttxt3" name="parenttxt3" class="form-control form-control-solid form-select" disabled="">
                            <option value=""></option>
                    ...
                    <div class="fv-row mb-10">
                        <label for="nametxt3" class="required form-label">Name</label>
                        <input id="nametxt3" name="nametxt3" type="text" class="form-control form-control-solid" disabled=""/>
                    </div>
                    <div class="fv-row mb-10">
                        <label for="descriptontxt3" class="required form-label">Description</label>
                        <textarea id="descriptontxt3" name="descriptontxt3" class="form-control form-control-solid" disabled=""></textarea>
                    </div>
                </div>
