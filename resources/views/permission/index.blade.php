...
<div class="card">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="table-permission" class="table table-rounded table-hover border my-5">
                <thead>
...
@include('permission.add_permission')
@endif
@if($user_access['update'])
@include('permission.edit_permission')
@endif
@if($user_access['delete'])
@include('permission.delete_permission')
@include('permission.restore_permission')
@include('permission.setting_permission')
@endif
@endsection
@push('scripts')
