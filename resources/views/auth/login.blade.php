...
<body id="kt_body" class="app-blank bgi-size-cover bgi-attachment-fixed bgi-position-center bgi-no-repeat">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        <style>
            body {
                background-image: url("{{ $paramsys['BACKGROUND_LOGIN'] }}")
            }
            ...
            <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
                <div class="d-flex flex-center flex-lg-start flex-column">
                    <a href="{{ route('login') }}" class="mb-7">
                        <img alt="Logo {{ $paramsys['APP_NAME'] }}" src="{{ $paramsys['LOGO_1'] }}"
                ...
                <div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
                    <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                        <form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate"
                            id="kt_sign_in_form" data-kt-redirect-url="{{ route('dashboard') }}"
                            action="{{ route('login') }}">
                            ...
                            <div class="fv-row mb-8 fv-plugins-icon-container">
                                <input type="text" placeholder="{{ __('Email Address') }}" name="email"
                            ...
                            <div class="fv-row fv-plugins-icon-container">
                                <input type="password" placeholder="Password" name="password" autocomplete="off"
                                    ...
                                    <div class="mb-3 my-10"></div>
                                <div id="cf-turnstile" class="cf-turnstile text-center"
                                    data-sitekey="{{ env('TURNSTILE_SITE_KEY') }}" data-theme="light"
                                    data-language="en">
                                </div>
                                <div
                                    class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
