    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="addModalLabel">Add New Sub Direktorat</h1>
            ...
            <form id="add_form" class="form" action="#" autocomplete="off" method="POST">
                ...
                <div class="modal-body">
                    <div class="fv-row mb-10">
                        <label for="nmatxt" class="required form-label">Nama Direktorat</label>
                        <select id="nmadir" name="nmadir" class="form-select form-select-solid" data-control="select2" data-placeholder="Pilih Direktorat" required="">
                    ...
                    <div class="fv-row mb-10">
                        <label for="nmatxt" class="required form-label">Nama Sub Direktorat</label>
    ...
    var validator = FormValidation.formValidation(form, {
        fields: {
            nmadir: {
                validators: {
                    notEmpty: {
                        message: 'The Name Direktorat is required'
                    }
                }
            },
            nmatxt: {
                validators: {
                    notEmpty: {
                        message: 'The Name Sub Direktorat is required'
                    }
                }
            }
        },
        ...
        if (validator) {
            validator.validate().then(function (status) {
                if (status == 'Valid') {
                    ...
                    fetch("{{ route('subdit.store', 'q=add') }}", {
                        method: 'POST',
                        body: formData
