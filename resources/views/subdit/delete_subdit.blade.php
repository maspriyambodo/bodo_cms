    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="deleteModalLabel">Delete Sub Direktorat</h1>
    ...
    function deleteData(id_direktorat) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.success) {
                    $('input[name="d_id"]').val(data.dt_subdit.id);
                    $('#deltxt').html('Are you sure you want to delete subdirektorat <strong>' + data.dt_subdit['nama'] + '</strong>?');
        ...
        if (validator3) {
            validator3.validate().then(function (status) {
                if (status == 'Valid') {
                    ...
                    fetch("{{ route('subdit.store', 'q=delete') }}", {
                        method: 'POST',
                        body: formData
                    })
