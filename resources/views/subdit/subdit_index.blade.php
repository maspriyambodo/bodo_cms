...
<div class="card">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="table-subdirektorat" class="table table-rounded table-hover border my-5">
                <thead>
                    <tr class="bg-light fw-bold fs-6 border-bottom-2 border-gray-200 text-center border">
                        ...
                        <th class="text-center">Nama Sub Direktorat</th>
...
@include('subdit.add_subdit')
@endif
@if($user_access['update'])
@include('subdit.edit_subdit')
@endif
@if($user_access['delete'])
@include('subdit.delete_subdit')
@include('subdit.restore_subdit')
@endif
@endsection
@push('scripts')
