...
<div class="card">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="table-bank" class="table table-rounded table-hover border my-5">
                <thead>
...
@include('nmbank.add_form')
@endif
@if($user_access['update'])
@include('nmbank.edit_form')
@endif
@if($user_access['delete'])
@include('nmbank.delete_form')
@include('nmbank.restore_form')
@endif
@endsection
@push('scripts')
