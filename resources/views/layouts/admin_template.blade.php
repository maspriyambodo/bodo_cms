...
<head>
    ...
    <meta property=og:title
        content="{{ ucfirst(str_replace('-', ' ', request()->route()->uri)) . ' | ' . $paramsys['APP_NAME'] }}">
    <meta property=og:url content="{{ url('') }}">
    @isset($paramsys['APP_NAME'])
        <meta property=og:site_name
            content="{{ str_replace('-', ' ', request()->route()->uri) . ' | ' . $paramsys['APP_NAME'] }}">
    @endisset
                ...
                <div id=kt_header class="header align-items-stretch">
                    ...
                    <div class=toolbar>
                        <div
                            ...
                            <div class="page-title d-flex flex-column me-5">
                                <h1 id="clock" class="d-flex flex-column text-dark fw-bolder fs-3 mb-0 text-capitalize">
                                </h1>
                                <h2 class="d-flex flex-column fs-3 mb-0 text-capitalize">{{ date('d F Y') }}<span
                                        id="dayName"></span></h2>
                            </div>
                        </div>
                    </div>
