...
<div class="card">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="table-kegiatan" class="table table-rounded table-hover border my-5" style="width: 100%;">
                <thead>
                    <tr class="bg-light fw-bold fs-6 border-bottom-2 border-gray-200 text-center border">
                        ...
                        <th class="text-center">Url Biodata</th>
                    </tr>
                </thead>
            </table>
...
@include('kegiatan.add_kegiatan')
@endif
@if($user_access['update'])
@include('kegiatan.edit_kegiatan')
@endif
@if($user_access['delete'])
@include('kegiatan.delete_kegiatan')
@include('kegiatan.restore_kegiatan')
@endif
@endsection
@push('scripts')
