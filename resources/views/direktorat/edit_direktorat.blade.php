    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="editModalLabel">Edit Data Direktorat</h1>
            ...
            <form id="edit_form" class="form" action="#" autocomplete="off">
                ...
                <div class="modal-body">
                    <div class="fv-row mb-10">
                        <label for="nmatxt2" class="required form-label">Nama Direktorat</label>
...
<script>
    function editData(val) {
        ...
        $.ajax({
            url: 'direktorat/edit/' + val,
            type: 'GET',
            dataType: 'json',
            success: function (data) {
                if (data.success) {
                    $('#eid').val(data.dt_direktorat['id']);
                    $('#nmatxt2').val(data.dt_direktorat['nama']);
        ...
        if (validator2) {
            validator2.validate().then(function (status) {
                if (status == 'Valid') {
                    ...
                    fetch("{{ route('direktorat.store', 'q=update') }}", {
                        method: 'POST',
                        body: formData
                    })
