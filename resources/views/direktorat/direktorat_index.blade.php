...
<div class="card">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="table-direktorat" class="table table-rounded table-hover border my-5">
                <thead>
...
@include('direktorat.add_direktorat')
@endif
@if($user_access['update'])
@include('direktorat.edit_direktorat')
@endif
@if($user_access['delete'])
@include('direktorat.delete_direktorat')
@include('direktorat.restore_direktorat')
@endif
@endsection
@push('scripts')
...
@include('direktorat.table_direktorat')
@endpush