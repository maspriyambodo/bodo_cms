...
<div class="card">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="table-menu" class="table table-rounded table-hover border my-5">
                <thead>
...
@include('grupmenu.add_form')
@endif
@if($user_access['update'])
@include('grupmenu.edit_form')
@endif
@if($user_access['delete'])
@include('grupmenu.delete_form')
@include('grupmenu.restore_form')
@endif
@endsection
@push('scripts')
...
@include('grupmenu.table_grupmenu')
@endpush